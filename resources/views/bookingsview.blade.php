                     ...
                     <!-- Nav -->
						<nav id="nav">
                            ...
                            <li><a href="/customerhome">Home</a></li>
								...
								<li><a href="/todaybook">Todays booking</a></li>
        ...
        <div class="row">
            <div class="col">
               ...
               <tr style="color: #fff;">
                   ...
                   <td><button><a href="/booking/{{$booking->email}}/today" class="button primary">Checkout</a></button></td>
               </tr>
               @endforeach      
...
<html>
	<head>
		<title>PRO-Nail Studio | Bookings</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
